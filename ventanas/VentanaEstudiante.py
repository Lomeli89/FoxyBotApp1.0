...
# Form implementation generated from reading ui file 'VentanaEstudiante.ui'
#
...
class Ui_VentanaEstudiante(object):
    def setupUi(self, VentanaEstudiante):
        ...
        VentanaEstudiante.resize(1016, 540)
...
"}")
    ...
    def retranslateUi(self, VentanaEstudiante):
        ...
        self.label_2.setText(_translate("VentanaEstudiante", "Usuario"))
        ...
        self.pushButton.setText(_translate("VentanaEstudiante", "Enviar"))
        self.lineEdit.setPlaceholderText(_translate("VentanaEstudiante", "¡Escribe aquí tus dudas!"))
        self.label.setText(_translate("VentanaEstudiante", "<html><head/><body><p><span style=\" font-size:18pt;\">FOXYBOT v0.1</span></p></body></html>"))
