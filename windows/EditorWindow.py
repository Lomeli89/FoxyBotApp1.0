...
class Ui_MainWindowEditor(object):
    def setupUi(self, MainWindowEditor):
        MainWindowEditor.setObjectName("MainWindowEditor")
        MainWindowEditor.resize(910, 610)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindowEditor.sizePolicy().hasHeightForWidth())
        MainWindowEditor.setSizePolicy(sizePolicy)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../img/298809902_539628011298194_5839572564237821349_n.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        MainWindowEditor.setWindowIcon(icon)
        MainWindowEditor.setStyleSheet("background-color: rgb(45, 45, 45);")
        self.centralwidget = QtWidgets.QWidget(MainWindowEditor)
...
"")
        ...
        self.btn_menu.setMinimumSize(QtCore.QSize(0, 30))
        self.btn_menu.setMaximumSize(QtCore.QSize(171, 30))
...
"color: rgb(167, 182, 203);")
        ...
        MainWindowEditor.setCentralWidget(self.centralwidget)

        self.retranslateUi(MainWindowEditor)
        self.stackedWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(MainWindowEditor)
        ...
        self.btn_menu.clicked.connect(lambda: self.stackedWidget.setCurrentWidget(self.page_servicios))
        self.btn_cerrarSesion.clicked.connect(lambda: self.stackedWidget.setCurrentWidget(MainWindowEditor.close()))
    ...
    def retranslateUi(self, MainWindowEditor):
            _translate = QtCore.QCoreApplication.translate
            MainWindowEditor.setWindowTitle(_translate("MainWindowEditor", "Editor"))
            self.label_user.setText(_translate("MainWindowEditor", "Usuario"))
            self.label_estudiante.setText(_translate("MainWindowEditor", "Editor"))
            self.btn_chat.setText(_translate("MainWindowEditor", "Chat"))
            self.btn_menu.setText(_translate("MainWindowEditor", "Menú de contenido"))
            self.btn_about.setText(_translate("MainWindowEditor", "Sobre Foxy Bot"))
            self.btn_cerrarSesion.setText(_translate("MainWindowEditor", "Cerrar Sesión"))
            self.label.setText(_translate("MainWindowEditor", "<html><head/><body><p><span style=\" color:#ffffff;\">FOXYBOT</span></p></body></html>"))
            self.lineEdit.setPlaceholderText(_translate("MainWindowEditor", "¡Escribe aquí tus dudas!"))
            self.btn_enviar.setText(_translate("MainWindowEditor", "Enviar"))
            self.label_3.setText(_translate("MainWindowEditor", "<html><head/><body><p><span style=\" font-size:18pt;\">Contenido: Preguntas/Respuestas de Foxy Bot</span></p></body></html>"))
            self.btn_eliminar.setText(_translate("MainWindowEditor", "eliminar"))
            self.btn_Nuevo.setText(_translate("MainWindowEditor", "+Nuevo"))
            item = self.tableWidget.horizontalHeaderItem(0)
            item.setText(_translate("MainWindowEditor", "Área de Servicio"))
            item = self.tableWidget.horizontalHeaderItem(1)
            item.setText(_translate("MainWindowEditor", "Título"))
            item = self.tableWidget.horizontalHeaderItem(2)
            item.setText(_translate("MainWindowEditor", "Solución"))
            item = self.tableWidget.horizontalHeaderItem(3)
            item.setText(_translate("MainWindowEditor", "Palabras clave"))
            item = self.tableWidget.horizontalHeaderItem(4)
            item.setText(_translate("MainWindowEditor", "Fecha de modif."))
            self.label_2.setText(_translate("MainWindowEditor", "<html><head/><body><p align=\"center\">FOXYBOT Versión 1.0</p></body></html>"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    MainWindowEditor = QtWidgets.QMainWindow()
    ui = Ui_MainWindowEditor()
    ui.setupUi(MainWindowEditor)
    MainWindowEditor.show()
    sys.exit(app.exec_())
