...
class Ui_MainWindowAdmin(object):
    def setupUi(self, MainWindowAdmin):
        ...
        MainWindowAdmin.resize(910, 600)
...
"")
        ...
        self.btn_Nuevo_3 = QtWidgets.QPushButton(self.frame_27)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_Nuevo_3.sizePolicy().hasHeightForWidth())
        self.btn_Nuevo_3.setSizePolicy(sizePolicy)
...
"color: rgb(167, 182, 203);")
    ...
    def retranslateUi(self, MainWindowAdmin):
        ...
        self.btn_servicios.setText(_translate("MainWindowAdmin", "Gestión de servicios"))
        ...
        item.setText(_translate("MainWindowAdmin", "Numero de soluciones"))
        ...
        item.setText(_translate("MainWindowAdmin", "Estado"))
        item = self.tableWidget_3.horizontalHeaderItem(1)
        item.setText(_translate("MainWindowAdmin", "Nombre"))
        item = self.tableWidget_3.horizontalHeaderItem(2)
        item.setText(_translate("MainWindowAdmin", "Coreo"))
        item = self.tableWidget_3.horizontalHeaderItem(3)
        item.setText(_translate("MainWindowAdmin", "Num. Empleado"))
        item = self.tableWidget_3.horizontalHeaderItem(4)
        item.setText(_translate("MainWindowAdmin", "Fecha de adiciòn"))
