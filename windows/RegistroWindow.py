                    ...
                    if x in signos or x in numeros or x in minusculas or x in mayusculas:
                        if dominio in dominios:
                            if terminacion in extensiones:
                                ...
                                import tkinter
                                from tkinter import messagebox
                                error = tkinter.messagebox.showerror("Error Correo",
                                                                     "La terminación no es común pero puede ser valido \n")
                        else:
                            problema_email += "El dominio  no es reconocido pero puede ser privado \n"
                            import tkinter
                            from tkinter import messagebox
                            error = tkinter.messagebox.showerror("Error Correo",
                                                                 "El dominio  no es reconocido pero puede ser privado")
                    else:
                        problema_email += "El valor " + x + " no es valido para un correo \n"
                        import tkinter
                        from tkinter import messagebox
                        error = tkinter.messagebox.showerror("Error Correo",
                                                             "El valor " + x + " no es valido para un correo")
            else:
