...
class Ui_MainWindowVisitante(object):
    def setupUi(self, MainWindowVisitante):
        MainWindowVisitante.setObjectName("MainWindowVisitante")
        MainWindowVisitante.resize(800, 600)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindowVisitante.sizePolicy().hasHeightForWidth())
        MainWindowVisitante.setSizePolicy(sizePolicy)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../img/298809902_539628011298194_5839572564237821349_n.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        MainWindowVisitante.setWindowIcon(icon)
        MainWindowVisitante.setStyleSheet("background-color: rgb(45, 45, 45);")
        self.centralwidget = QtWidgets.QWidget(MainWindowVisitante)
...
"color: rgb(167, 182, 203);")
        ...
        MainWindowVisitante.setCentralWidget(self.centralwidget)

        self.retranslateUi(MainWindowVisitante)
        self.stackedWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(MainWindowVisitante)
    ...
    def retranslateUi(self, MainWindowVisitante):
        _translate = QtCore.QCoreApplication.translate
        MainWindowVisitante.setWindowTitle(_translate("MainWindowVisitante", "Visitante"))
        self.label_user.setText(_translate("MainWindowVisitante", "Usuario"))
        self.label_estudiante.setText(_translate("MainWindowVisitante", "Visitante"))
        self.btn_chat.setText(_translate("MainWindowVisitante", "Chat"))
        self.btn_about.setText(_translate("MainWindowVisitante", "Sobre Foxy Bot"))
        self.btn_cerrarSesion.setText(_translate("MainWindowVisitante", "Cerrar Sesión"))
        self.label.setText(_translate("MainWindowVisitante", "<html><head/><body><p><span style=\" color:#ffffff;\">FOXYBOT</span></p></body></html>"))
        self.lineEdit.setPlaceholderText(_translate("MainWindowVisitante", "¡Escribe aquí tus dudas!"))
        self.btn_enviar.setText(_translate("MainWindowVisitante", "Enviar"))
        self.label_2.setText(_translate("MainWindowVisitante", "<html><head/><body><p align=\"center\">FOXYBOT Versión 1.0</p></body></html>"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    MainWindowVisitante = QtWidgets.QMainWindow()
    ui = Ui_MainWindowVisitante()
    ui.setupUi(MainWindowVisitante)
    MainWindowVisitante.show()
    sys.exit(app.exec_())
